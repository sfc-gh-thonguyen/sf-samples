...
_NEW_CALL_METHOD = '''\
    ...
    async def __call__(self, *args, **kwargs) -> float:
        ...
        if cls._async_reward_fn_resolved is None:
            try:
                from policy_rl_local_judges_spcs_runtime.policy_reward import async_policy_reward_fn
...
def main():
    ...
    local_dst = os.path.join(REWARD_MODULE_DIR, "policy_rl_local_judges_spcs_runtime")
    ...
    reward_fn_path = "policy_rl_local_judges_spcs_runtime.policy_reward.policy_reward_fn"
