#!/usr/bin/env python3
"""
Medical SOAP RL Training — LoRA + SGLang recipe.
...
GPU layout (8x A100-40GB):
  GPUs 0-4: AReaL (4 rollout + 1 training)
  GPUs 5-7: vLLM judge servers (one per GPU)
...
# GPU layout: GPUs 0-4 for AReaL (4 rollout + 1 training), GPUs 5-7 for judges
JUDGE_GPUS = [5, 6, 7]
NUM_AREAL_GPUS = 5
...
print("=" * 60)
print("Medical SOAP RL Training — LoRA + SGLang")
print("=" * 60)
...
from patches import _patch_sglang_lora, _patch_reward_api  # noqa: E402
...
def main():
    ...
    # 3. Patch SGLang + LoRA compatibility
