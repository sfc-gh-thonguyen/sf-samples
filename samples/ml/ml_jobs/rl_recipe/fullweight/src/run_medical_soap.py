#!/usr/bin/env python3
"""
Medical SOAP RL Training — Full-Weight (no LoRA, no SGLang).
...
GPU layout (8x A100-40GB):
  GPUs 0-5: AReaL training
  GPUs 6-7: vLLM judge servers (one per GPU)
...
# Install AReaL + vLLM (--no-deps to avoid torch reinstall).
...
# GPU layout: GPUs 0-5 for AReaL, GPUs 6-7 for judges
JUDGE_GPUS = [6, 7]
NUM_AREAL_GPUS = 6
...
print("=" * 60)
print("Medical SOAP RL Training (Full-Weight)")
print("=" * 60)
